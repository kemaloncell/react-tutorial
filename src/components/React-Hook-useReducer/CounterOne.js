import React, {useReducer} from "react"; // step 1 define the useState from react
 ...
 * step 2 define the useReducer it will be take 2 parameter one of them method that returned current state
 and other paramater is action when we want to give a condiditon wes can use second poramater like this
